      ...
      <section aria-labelledby="watchlist-items-heading">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Link
              href="/movies"
              className="rounded-md bg-zinc-950 px-4 py-2 text-center text-sm font-medium text-white transition hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 dark:bg-zinc-100 dark:text-zinc-950 dark:hover:bg-zinc-200 dark:focus:ring-zinc-100"
            >
              Add movie to the watchlist
            </Link>
            <Link
              href="/series"
              className="rounded-md border border-zinc-200 px-4 py-2 text-center text-sm font-medium transition hover:bg-zinc-100 focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 dark:border-zinc-800 dark:hover:bg-zinc-900 dark:focus:ring-zinc-100"
            >
        ...
        {watchlist.items.length === 0 ? (
          <div className="mt-4 rounded-lg border border-dashed border-zinc-300 bg-white px-5 py-10 text-center shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
            ...
            <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
              Browse the catalog and add something you want to watch.
            </p>
          </div>
        ) : (
