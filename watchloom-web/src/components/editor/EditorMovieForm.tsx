...
export function EditorMovieForm({
  action,
  genres,
  submitLabel,
  error,
    ...
    >
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <label className="block text-sm font-medium lg:col-span-2">
          Director
          <input name="director" defaultValue={defaultValues?.director ?? ""} className={inputClass} />
        </label>
      </div>
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2">
        <label className="block text-sm font-medium">
          Writer
          <input name="writer" defaultValue={defaultValues?.writer ?? ""} className={inputClass} />
        </label>
        <label className="block text-sm font-medium">
          Cast
